...
Funcionalidade: Enviar localização para o OJO-Web
  ...
  Cenário: Visualizar timeline
    ...
    Então deve ser exibido a timeline com número do mandado do check-in
    Então deve ser exibido a timeline com endereço do check-in
    Então deve ser exibido a timeline com hora do check-in
    Então deve ser exibido a timeline com status de sincronização do check-in